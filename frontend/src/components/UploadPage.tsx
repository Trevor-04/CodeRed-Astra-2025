  ...
  return (
    <div className=" container mx-auto px-4 py-8 max-w-6xl">
      <Button
        ...
        variant="outline"
        size="lg"
        className="cursor-pointer border-blue-800 border-2 text-blue-700 mb-6"
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                ...
                them to LaTeX and make them accessible with audio reading.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <MathImageProcessor
                onProcessingComplete={(result) => {
                  console.log('Math processing completed:', result);
                  // TODO: Save to uploads and workspace
                }}
                onError={(error) => {
