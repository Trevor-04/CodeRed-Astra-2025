    ...
    <main className="container mx-auto px-6 lg:px-12 py-6 lg:py-12 max-w-[1200px]" role="main">
      ...
      <div className="grid gap-6 lg:gap-8 grid-cols-1 lg:grid-cols-2 mb-8 lg:mb-12">
        ...
        <Button
          ...
          className="h-auto py-12 lg:py-16 flex flex-col items-center gap-4 bg-[#1D4ED8] hover:bg-[#1E40AF] text-white text-xl rounded-lg shadow-lg transition-all duration-200 hover:scale-105 px-6"
        ...
        <Button
          ...
          className="h-auto py-12 lg:py-16 flex flex-col items-center gap-4 bg-[#2563EB] hover:bg-[#1D4ED8] text-white text-xl rounded-lg shadow-lg transition-all duration-200 hover:scale-105 px-6"
